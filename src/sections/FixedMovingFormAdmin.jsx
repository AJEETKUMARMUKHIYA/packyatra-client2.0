      ...
      <div className="form-container-premium" style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "8px", flexWrap: "wrap", marginBottom: "12px" }}>
          <span style={{
            ...
            <FontAwesomeIcon icon={faShieldAlt} /> Secure Quote
          </span>
          <span style={{
            ...
            <FontAwesomeIcon icon={faUserShield} /> Admin Entry
          </span>
        </div>
        ...
        <p style={{
          ...
          Create admin ticket and calculate shifting prices instantly.
        </p>
        ...
        <button 
          ...
          onClick={handleCheckPricesAdmin}
          style={{
            width: "100%",
            ...
            fontWeight: "700",
            cursor: "pointer",
            boxShadow: "0 10px 20px -5px rgba(107, 33, 168, 0.3), 0 4px 6px -2px rgba(107, 33, 168, 0.05)",
...
export default FixedMovingFormAdmin;